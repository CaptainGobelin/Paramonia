...
public class SimConst {
	...
	public static final int STARTING_PARAMITE_NB = 100;
	...
	public static final float NEURAL_THRESHOLD = 0.05f;
	public static final float MUTATION_RATE = 0.1f;
	
	public static final double SPOOCE_GROWING_RATE = 5.2e-2;
	...
	public static final double PARAMITE_STARTING_ENERGY = 1000;
	public static final double PARAMITE_EATING_ENERGY = 300;
